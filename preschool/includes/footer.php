                ...
                <?php } ?>
                    ...
                    <div class="col-lg-5 col-md-6">
                        ...
                        <div class="row g-2 pt-2">
                            ...
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="img/activity1.jpg" alt="" style="height: -webkit-fill-available;">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="img/classes-5.jpg" alt="">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="img/activity4.jpeg" alt="" style="height: -webkit-fill-available;">
                            </div>
                        </div>
                    </div>
